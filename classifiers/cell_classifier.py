...
to predict whether a given segmentation is or is not worth considering.
'''

if __name__ == '__main__':

    # path to training data
    training_data_path = '/Volumes/bigData/wholeMount_volDist/220712_Fix_Emb_Flvw_Chn1GAP_PI_aTub647_Processed/N2V_Denoised/0_Analysis_01/0_data_cubes/cell_label_properties'
    ...
    joblib.dump(classifier, os.path.join(sys.path[0], 'cell_classifier.joblib'))
